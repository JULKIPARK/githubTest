...
import com.pwc.pwcesg.frontoffice.search.dao.WebcontentsDAO;
...
public class WebcontentsService {
	...
	private final WebcontentsDAO webcontentsDAO;
	...
	public RestResultVO WebcontentsSearch(ParameterVO paramVO) throws Exception {
		RestResultVO resultVO = webcontentsDAO.WebcontentsSearch(paramVO);
